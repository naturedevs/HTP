        ...
        <div className="max-w-[1280px] w-full mx-auto md:flex">
          <div className="flex-1">
            <div className="bg-white m-5 p-5 space-y-3">
              <p className="md:font-[700] md:text-[30px] md:leading-[30px] font-[700] text-[30px] leading-[30px] text-black">
          ...
          <div className="flex-1">
            <div className="bg-white m-5 p-5 space-y-3">
              <img
                ...
                src={event && event.img_file}
              ></img>
              <p className="md:font-[500] md:text-[24px] md:leading-[24px] font-[500] text-[24px] leading-[24px] text-black line-clamp-2">
                {event && event.name}
              </p>
              <p className="text-[#777777] text-[14px] leading-[14px]">
                {event && month[parseInt(moment(event.date).format("MM"))]}{" "}
                {event && moment(event.date).format("DD")}{" "}
                {event && day[new Date(event.date).getDay()]}{" "}
                {event && " - " + moment(event.date).format("hh:mm A")}
              </p>
              <p className="text-[#777777] text-[14px] leading-[14px]">
                BankPlus Amphitheater at Snowden Grove, Southaven, MS
              </p>
              <p className="text-[#272727] text-[14px] leading-[18px] line-clamp-3">
                Here’s a list of upcoming events by our band in different
              ...
              <div className="flex mx-auto justify-between">
                <p className="text-[#272727] text-[14px] leading-[18px]">
                  Total Cost:
                </p>
                <p className="text-primaryColor font-[800] text-[25px] leading-[18px]">
                  $50
                </p>
              </div>
            </div>
            ...
            <div className="pr-5 pl-5">
              <button
                type="submit"
                className="w-full md:h-[54px] h-[45px] bg-primaryColor text-[17px] text-[#FFFFFF]"
