...
function Home() {
  return (
    <div className="w-full">
      <div className="homeBg1 content-center grid grid-cols-5 items-center">
        ...
        <form className="relative col-span-2 flex justify-start w-[410px] py-12 px-8 rounded-[30px] ml-8">
